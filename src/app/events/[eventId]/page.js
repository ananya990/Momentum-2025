  ...
  return (
    <>
      <div className="relative min-h-screen w-full overflow-hidden">
        ...
        <div className="relative flex flex-col md:flex-row justify-center items-start md:items-center gap-8 px-6 md:px-16 py-12 z-10 pt-20">
          <PosterBox poster={event.poster} title={event.title} eventId/>
